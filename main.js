...
Promise.all([
  ...
  function setup() {
    ...
    x_scale_us = d3.scaleTime().domain(
   ...
   ///////////////////////////////////////////////////////////////////////////
    ...
    // x axis grid lines
    mobility_y_grid = svg_us.append("g").attr("class", "grid");
    ...
    svg_us
      ...
      .attr(
        "d",
        d3.line()([
          [arrow_margin.left, arrow_margin.top],
          [arrow_margin.left, arrow_margin.bottom],
        ])
      )
      .attr("stroke", "black")
      .attr("stroke-width", line_width)
    ...
    // x axis grid lines
    scatter_x_grid = svg_scatter.append("g").attr("class", "grid");

    // y axis grid lines
    scatter_y_grid = svg_scatter.append("g").attr("class", "grid");
  ...
  function resize() {
    ...
    svg_state
      ...
      .attr(
        "transform",
        "translate(" + label_type_size + "," + margin.top + ")"
      );
    ...
    lines_btwn
      ...
      .attr(
        ...
        "translate(" +
          margin.left +
          "," +
          (margin.top + lag_label_type_size) +
          ")"
      );
    ...
    var cases_height = us_height * 0.475 - margin.top;
    ...
    var mobility_label_height =
      us_height - arrow_margin.top - margin.top - label_leading;
    ...
    svg_us.selectAll(".arrow_mobility").attr(
      "d",
      d3.line()([
        [arrow_margin.left, mobility_arrow_height - arrow_margin.bottom],
        [arrow_margin.left, mobility_arrow_height - arrow_margin.top],
      ])
    );
    ...
    cases_y_grid
      .call(
        cases_y_gridlines().tickSize(-width).tickFormat("").tickSizeOuter(0)
      )
      .attr("transform", "translate(" + margin.left + "," + 0 + ")");
    ...
    // y axis
    y_scale_mobility.range([us_height - margin.top, mobility_start_height]);
    ...
    svg_scatter.selectAll(".arrow_scatter").attr(
      "d",
      d3.line()([
        [scatter_x_label_length + arrow_margin.right, scatter_label_height],
        [scatter_x_label_length + arrow_margin.left, scatter_label_height],
      ])
    );
